  ...
  ),
  {
    variants: {
      variant: {
        ...
        headlineLarge: "text-3xl font-semibold",
        headlineMedium: "text-2xl font-semibold",
        headlineSmall: "text-xl font-semibold",
        ...
        labelSmall: "text-[11px] font-semibold tracking-wide",
        bodyLarge: "text-base",
        bodyMedium: "text-sm",
        bodySmall: "text-xs",
        h1: cn(
